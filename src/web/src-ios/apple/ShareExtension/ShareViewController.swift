...
class ShareViewController: SLComposeServiceViewController {
    ...
    private func saveFileToAppDirectory(_ fileURL: URL) {
        ...
        // 使用 App Group 共享目录
        guard let sharedContainerURL = FileManager.default.containerURL(forSecurityApplicationGroupIdentifier: "group.com.flomesh.clawparty") else {
        ...
        do {
            ...
            NSLog("Error: Unable to save file - \(error.localizedDescription)")
				...
				// 使用以下代码打开主应用
				if let url = URL(string: "clawparty://") {
