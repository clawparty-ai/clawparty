...
| `max_tool_iterations` | `100` | Maximum tool-call loop turns per user message across CLI, gateway, and channels |
...
- Setting `max_tool_iterations = 0` falls back to safe default `100`.
