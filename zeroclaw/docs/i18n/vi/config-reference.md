...
| `max_tool_iterations` | `100` | Số vòng lặp tool-call tối đa mỗi tin nhắn trên CLI, gateway và channels |
...
- Đặt `max_tool_iterations = 0` sẽ dùng giá trị mặc định an toàn `100`.
