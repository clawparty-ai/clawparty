<template>
  <div class="task-panel" :class="{ fullscreen: isFullscreen }" :style="{ height: isFullscreen ? '100vh' : panelHeight + 'px' }">
...
.task-fullscreen-btn:hover,
.task-fullscreen-btn.active {
  background: rgba(64, 149, 254, 0.1);
  color: #4095fe;
}
