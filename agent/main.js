...
function main(listen, apiToken, noAuth, adminPassword) {
  ...
  var routes = Object.entries({
    ...
    // ── Wiki APIs (moved to tui proxy layer) ───────────────────────
    // Wiki API routes are handled by the Rust proxy (tui) to avoid
    // PipyJS compatibility issues with continue/break/while/regex.
    // See tui/src/proxy.rs for implementation.
