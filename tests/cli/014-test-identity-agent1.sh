#!/bin/bash
#
# 014-test-identity-agent1.sh - Test Agent1 identity command
#
# Command: ztm identity
# Environment: ZTM_CONFIG=127.0.0.1:7778, ZTM_API_TOKEN=enjoy-party
...
echo "=========================================="
echo "Test: 014-test-identity-agent1.sh"
