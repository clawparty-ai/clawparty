#!/bin/bash
#
# 024-test-unban-user.sh - Test unban user
#
# Endpoint: DELETE /api/evict/{username}
# Access: mTLS
...
echo "=========================================="
echo "Test: 024-test-unban-user.sh"
echo "Endpoint: DELETE $HUB_URL/api/evict/{username}"
